...
ALLOWED_HOSTS = ['foodfinderbd.onrender.com', 'foodfinder-bd.onrender.com', 'localhost', '127.0.0.1']
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Changed to avoid confusion
STATICFILES_DIRS = [
    'FoodFinder/static'
]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'FoodFinder Marketplace <info@FoodFinder.com>'
